...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=True, epsilon=1.0, alpha=0.5,t=1):
    ...
    def build_state(self):
        ...
        state = (str(waypoint)+str(inputs['light'])+str(inputs['left'])+str(inputs['oncoming']))
    ...
    def get_maxQ(self, state):
        ...
        ma = self.Q[state]
        maxQ= self.Q[state][max(ma,key=lambda k:ma[k])]
        #maxQ = max(ma,key=lambda k:ma[k])
...
def run():
    ...
    sim = Simulator(env,update_delay=.0000001, log_metrics=True, optimized=True, display=False)
