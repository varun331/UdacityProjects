...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = (str(waypoint)+"_"+str(inputs['light'])+"_"+str(inputs['left'])+str(inputs['oncoming'])+"_"+str(deadline))
...
def run():
    ...
    sim.run(n_test=200,tolerance=.0014)
